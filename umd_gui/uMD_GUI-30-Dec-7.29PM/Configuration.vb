...
Public Class Configuration
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        End If
        If Encoder_Checkbox.Checked = True Then
            MainForm.AngleButton.Text = "Encoder Angle"
        Else
            MainForm.AngleButton.Text = "Angle"
        End If
    ...
    Private Sub encoder_checkbox_changed(sender As Object, e As EventArgs) Handles Encoder_Checkbox.CheckedChanged
        If Encoder_Checkbox.Checked = True Then
            MainForm.AngleButton.Text = "Encoder Angle"
            If MainForm.AngleButton.ForeColor = Color.FromKnownColor(KnownColor.ActiveCaptionText) Then
                MainForm.Graph_Label.Text = "Encoder Angle"
            End If
        Else
            MainForm.AngleButton.Text = "Angle"
            If MainForm.AngleButton.ForeColor = Color.FromKnownColor(KnownColor.ActiveCaptionText) Then
                MainForm.Graph_Label.Text = "Angle"
            End If
        End If
    End Sub
